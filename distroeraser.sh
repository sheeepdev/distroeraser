...
sleep 1
gum confirm "Are you sure you want to permanently erase your system?" && gum spin -s minidot --title 'Erasing the system...' dd if=/dev/zero of="$DISK" bs=1M status=progress || echo "Cancelled"
